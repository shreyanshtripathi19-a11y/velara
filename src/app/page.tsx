        ...
        <Link href="/windows" style={{ display: 'block', textDecoration: 'none', color: 'inherit' }}>
          <div className="sr d2 hm-prodline-grid hm-prodline-windows" style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: "32px", maxWidth: "1200px", margin: "0 auto 48px", padding: "0 24px", cursor: "pointer" }}>
            <div className="hm-prod-card" style={{ borderRadius: "var(--radius-lg)", overflow: "hidden", background: "var(--white)", display: "flex", flexDirection: "column", boxShadow: "0 2px 12px rgba(0,0,0,.04)" }}>
              ...
              <div className="rv-card-body" style={{ padding: "28px 32px 32px", display: "flex", flexDirection: "column", flex: 1 }}>
                <p className="hm-card-desc" style={{ color: "var(--ink)", fontSize: "1rem", lineHeight: 1.7, flex: 1 }}>The new modern, clean design built for new construction and stunning custom homes. Engineered with the latest technology for unmatched performance, sleek aesthetics, and the cleanest sightlines available.</p>
                <div className="hm-card-specs" style={{ display: "flex", gap: "32px", marginTop: "20px" }}>
                  <div><span className="hm-spec-val" style={{ color: "var(--accent)", fontSize: "1.3rem", fontWeight: 800 }}>4-9/16″</span><br /><span className="hm-spec-label" style={{ fontSize: "0.7rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: "1px" }}>Frame Depth</span></div>
                  <div><span className="hm-spec-val" style={{ color: "var(--accent)", fontSize: "1.3rem", fontWeight: 800 }}>Energy Star®</span><br /><span className="hm-spec-label" style={{ fontSize: "0.7rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: "1px" }}>Certified</span></div>
                </div>
              </div>
            </div>
            <div className="hm-prod-card" style={{ borderRadius: "var(--radius-lg)", overflow: "hidden", background: "var(--white)", display: "flex", flexDirection: "column", boxShadow: "0 2px 12px rgba(0,0,0,.04)" }}>
              ...
              <div className="rv-card-body" style={{ padding: "28px 32px 32px", display: "flex", flexDirection: "column", flex: 1 }}>
                <p className="hm-card-desc" style={{ color: "var(--ink)", fontSize: "1rem", lineHeight: 1.7, flex: 1 }}>The popular design trusted by thousands of homes across Canada. Classic styling with proven durability, premium features, and exceptional value — the go-to choice for renovations and replacements.</p>
                <div className="hm-card-specs" style={{ display: "flex", gap: "32px", marginTop: "20px" }}>
                  <div><span className="hm-spec-val" style={{ color: "var(--accent)", fontSize: "1.3rem", fontWeight: 800 }}>3-1/4″</span><br /><span className="hm-spec-label" style={{ fontSize: "0.7rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: "1px" }}>Frame Depth</span></div>
                  <div><span className="hm-spec-val" style={{ color: "var(--accent)", fontSize: "1.3rem", fontWeight: 800 }}>Energy Star®</span><br /><span className="hm-spec-label" style={{ fontSize: "0.7rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: "1px" }}>Certified</span></div>
                </div>
              </div>
            </div>
        ...
        <Link href="/doors" style={{ display: 'block', textDecoration: 'none', color: 'inherit' }}>
          <div className="sr d1 hm-prodline-grid hm-prodline-doors" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "24px", maxWidth: "1100px", margin: "0 auto 48px", padding: "0 24px", cursor: "pointer" }}>
            <div className="door-mat-card">
              ...
              <h3 className="hm-card-title" style={{ fontFamily: "var(--font-d)", fontSize: "1.5rem", fontWeight: 700, color: "var(--ink)", marginBottom: "8px" }}>Steel</h3>
              <p className="hm-card-desc" style={{ fontSize: ".88rem", color: "rgba(0,0,0,.6)", lineHeight: 1.7, fontWeight: 300, marginBottom: "20px" }}>Maximum security and durability. Polyurethane foam core for superior insulation. Dent-resistant and low maintenance.</p>
              <div className="hm-card-specs" style={{ display: "flex", gap: "16px", marginTop: "auto" }}>
                <div style={{ textAlign: "center" }}><span className="hm-spec-val" style={{ fontFamily: "var(--font-d)", fontSize: "1.3rem", fontWeight: 700, color: "var(--ink)", display: "block" }}>R-16</span><span className="hm-spec-label" style={{ fontSize: ".65rem", color: "rgba(0,0,0,.4)", textTransform: "uppercase", letterSpacing: ".06em", fontWeight: 500 }}>Insulation</span></div>
                <div style={{ width: "1px", background: "var(--rule)" }}></div>
                <div style={{ textAlign: "center" }}><span className="hm-spec-val" style={{ fontFamily: "var(--font-d)", fontSize: "1.3rem", fontWeight: 700, color: "var(--ink)", display: "block" }}>20ga</span><span className="hm-spec-label" style={{ fontSize: ".65rem", color: "rgba(0,0,0,.4)", textTransform: "uppercase", letterSpacing: ".06em", fontWeight: 500 }}>Steel Skin</span></div>
              </div>
            </div>
            <div className="door-mat-card">
              <div className="rv-card-img" style={{ height: "306px", background: "transparent", marginBottom: "24px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <h3 className="hm-card-title" style={{ fontFamily: "var(--font-d)", fontSize: "1.5rem", fontWeight: 700, color: "var(--ink)", marginBottom: "8px" }}>Fibreglass</h3>
              <p className="hm-card-desc" style={{ fontSize: ".88rem", color: "rgba(0,0,0,.6)", lineHeight: 1.7, fontWeight: 300, marginBottom: "20px" }}>Authentic woodgrain texture without the upkeep. Won{"'"}t warp, crack, or rot. Holds paint and stain beautifully for years.</p>
              <div className="hm-card-specs" style={{ display: "flex", gap: "16px", marginTop: "auto" }}>
                <div style={{ textAlign: "center" }}><span className="hm-spec-val" style={{ fontFamily: "var(--font-d)", fontSize: "1.3rem", fontWeight: 700, color: "var(--ink)", display: "block" }}>R-16</span><span className="hm-spec-label" style={{ fontSize: ".65rem", color: "rgba(0,0,0,.4)", textTransform: "uppercase", letterSpacing: ".06em", fontWeight: 500 }}>Insulation</span></div>
                <div style={{ width: "1px", background: "var(--rule)" }}></div>
                <div style={{ textAlign: "center" }}><span className="hm-spec-val" style={{ fontFamily: "var(--font-d)", fontSize: "1.3rem", fontWeight: 700, color: "var(--ink)", display: "block" }}>UV</span><span className="hm-spec-label" style={{ fontSize: ".65rem", color: "rgba(0,0,0,.4)", textTransform: "uppercase", letterSpacing: ".06em", fontWeight: 500 }}>Resistant</span></div>
              </div>
            </div>
            <div className="door-mat-card">
              <div className="rv-card-img" style={{ height: "306px", background: "transparent", marginBottom: "24px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <div className="hm-card-badge-row" style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "12px" }}>
                <span className="hm-card-badge" style={{ fontSize: ".68rem", padding: "4px 10px", borderRadius: "20px", background: "rgba(0,0,0,.06)", color: "rgba(0,0,0,.5)", fontWeight: 600, letterSpacing: ".04em", textTransform: "uppercase" }}>Premium</span>
              </div>
              <h3 className="hm-card-title" style={{ fontFamily: "var(--font-d)", fontSize: "1.5rem", fontWeight: 700, color: "var(--ink)", marginBottom: "8px" }}>Solid Wood</h3>
              <p className="hm-card-desc" style={{ fontSize: ".88rem", color: "rgba(0,0,0,.6)", lineHeight: 1.7, fontWeight: 300, marginBottom: "20px" }}>Timeless craftsmanship in mahogany, oak, or knotty alder. The warmth and character only real wood delivers.</p>
              <div className="hm-card-specs" style={{ display: "flex", gap: "16px", marginTop: "auto" }}>
                <div style={{ textAlign: "center" }}><span className="hm-spec-val" style={{ fontFamily: "var(--font-d)", fontSize: "1.3rem", fontWeight: 700, color: "var(--ink)", display: "block" }}>Custom</span><span className="hm-spec-label" style={{ fontSize: ".65rem", color: "rgba(0,0,0,.4)", textTransform: "uppercase", letterSpacing: ".06em", fontWeight: 500 }}>Stains</span></div>
                <div style={{ width: "1px", background: "var(--rule)" }}></div>
                <div style={{ textAlign: "center" }}><span className="hm-spec-val" style={{ fontFamily: "var(--font-d)", fontSize: "1.3rem", fontWeight: 700, color: "var(--ink)", display: "block" }}>Solid</span><span className="hm-spec-label" style={{ fontSize: ".65rem", color: "rgba(0,0,0,.4)", textTransform: "uppercase", letterSpacing: ".06em", fontWeight: 500 }}>Core</span></div>
              </div>
            </div>
          </div>
        </Link>
          ...
          <div className="sr d1 hm-prodline-grid hm-prodline-garage" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "24px", maxWidth: "1200px", margin: "0 auto", padding: "0 24px", cursor: "pointer" }}>
            ...
            <div className="hm-prod-card" style={{ borderRadius: "var(--radius-lg)", overflow: "hidden", background: "var(--white)", boxShadow: "0 2px 12px rgba(0,0,0,.04)", display: "flex", flexDirection: "column" }}>
              ...
              <div className="rv-card-body" style={{ padding: "24px 28px 28px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                <div className="hm-card-specs" style={{ display: "flex", gap: "24px", marginTop: "20px" }}>
                  <div><span className="hm-spec-val" style={{ color: "var(--accent)", fontSize: "1.1rem", fontWeight: 800 }}>R-18</span><br /><span className="hm-spec-label" style={{ fontSize: "0.65rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: "1px" }}>Insulation</span></div>
                  <div><span className="hm-spec-val" style={{ color: "var(--accent)", fontSize: "1.1rem", fontWeight: 800 }}>20ga</span><br /><span className="hm-spec-label" style={{ fontSize: "0.65rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: "1px" }}>Steel Skin</span></div>
                </div>
              </div>
            </div>
            {/* Natural Wood */}
            <div className="hm-prod-card" style={{ borderRadius: "var(--radius-lg)", overflow: "hidden", background: "transparent", boxShadow: "0 2px 12px rgba(0,0,0,.04)", display: "flex", flexDirection: "column" }}>
              ...
              <div className="rv-card-body" style={{ padding: "24px 28px 28px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                <div className="hm-card-specs" style={{ display: "flex", gap: "24px", marginTop: "20px" }}>
                  <div><span className="hm-spec-val" style={{ color: "var(--accent)", fontSize: "1.1rem", fontWeight: 800 }}>Solid</span><br /><span className="hm-spec-label" style={{ fontSize: "0.65rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: "1px" }}>Hardwood</span></div>
                  <div><span className="hm-spec-val" style={{ color: "var(--accent)", fontSize: "1.1rem", fontWeight: 800 }}>R-14</span><br /><span className="hm-spec-label" style={{ fontSize: "0.65rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: "1px" }}>Insulation</span></div>
                </div>
              </div>
            </div>
            {/* Aluminum & Glass */}
            <div className="hm-prod-card" style={{ borderRadius: "var(--radius-lg)", overflow: "hidden", background: "transparent", boxShadow: "0 2px 12px rgba(0,0,0,.04)", display: "flex", flexDirection: "column" }}>
              ...
              <div className="rv-card-body" style={{ padding: "24px 28px 28px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                <div className="hm-card-specs" style={{ display: "flex", gap: "24px", marginTop: "20px" }}>
                  <div><span className="hm-spec-val" style={{ color: "var(--accent)", fontSize: "1.1rem", fontWeight: 800 }}>Tempered</span><br /><span className="hm-spec-label" style={{ fontSize: "0.65rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: "1px" }}>Glass</span></div>
                  <div><span className="hm-spec-val" style={{ color: "var(--accent)", fontSize: "1.1rem", fontWeight: 800 }}>Anodized</span><br /><span className="hm-spec-label" style={{ fontSize: "0.65rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: "1px" }}>Frame</span></div>
                </div>
              </div>
            </div>
          </div>
