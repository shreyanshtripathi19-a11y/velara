  ...
  return (
    <div className="homepage">
      ...
      <section style={{ padding: "clamp(48px,5vw,80px) 0 clamp(48px,5vw,80px)", background: "var(--white)" }}>
        ...
        <div className="sr d2 hm-prodline-windows" style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "40px", maxWidth: "1400px", width: "100%", boxSizing: "border-box", margin: "0 auto 56px", padding: "0 40px" }}>
          {/* V Series */}
          <div className="win-card-h">
            <div className="win-card-img-wrap">
              <div className="win-card-tag" style={{ background: "#4a7c59" }}>V Series</div>
            ...
            <div className="win-card-content">
              ...
              <p className="win-card-desc">The new modern, clean design built for new construction and stunning custom homes. Engineered with the latest technology for unmatched performance, sleek aesthetics, and the cleanest sightlines available.</p>
              <div className="win-card-specs">
                <div className="win-spec-item"><span className="win-spec-val">4-9/16&Prime;</span><span className="win-spec-label">Frame Depth</span></div>
                {/* <div className="win-spec-divider" /> */}
                <div className="win-spec-item"><span className="win-spec-val">Energy Star&reg;</span><span className="win-spec-label">Certified</span></div>
                {/* <div className="win-spec-divider" /> */}
                <div className="win-spec-item"><span className="win-spec-val">Triple</span><span className="win-spec-label">Glazing Option</span></div>
              </div>
            </div>
          </div>
          {/* Signature Series */}
          <div className="win-card-h">
            <div className="win-card-img-wrap">
              <div className="win-card-tag" style={{ background: "#1a2744" }}>Signature Series</div>
            ...
            <div className="win-card-content">
              ...
              <p className="win-card-desc">The popular design trusted by thousands of homes across Canada. Classic styling with proven durability, premium features, and exceptional value &mdash; the go-to choice for renovations and replacements.</p>
              <div className="win-card-specs">
                <div className="win-spec-item"><span className="win-spec-val">3-1/4&Prime;</span><span className="win-spec-label">Frame Depth</span></div>
                {/* <div className="win-spec-divider" /> */}
                <div className="win-spec-item"><span className="win-spec-val">Energy Star&reg;</span><span className="win-spec-label">Certified</span></div>
                <div className="win-spec-divider" />
                <div className="win-spec-item"><span className="win-spec-val">25-Year</span><span className="win-spec-label">Warranty</span></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="sr d1 hm-prodline-grid hm-prodline-doors" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "40px", maxWidth: "1360px", width: "100%", boxSizing: "border-box", margin: "0 auto 48px", padding: "0 32px" }}>
        ...
        <div className="sr d1 hm-prodline-grid hm-prodline-garage" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "40px", maxWidth: "1360px", width: "100%", boxSizing: "border-box", margin: "0 auto", padding: "0 32px" }}>
          {/* Steel */}
